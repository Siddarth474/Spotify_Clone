...
const Player = () => {
    ...
    const {seekBg, seekBar, seekSong, track,play,pause,playStatus,next,previous,time} = useContext(PlayerContext);

  return (
    <div className='h-[10%] w-full flex items-center justify-between  px-3'>
        <div className='text-white hidden lg:flex items-center ml-2'>
            <img src={track.image} className='w-[55px] rounded-sm' alt='' />
            <div className='ml-3'>
                <p>{track.name}</p>
        ...
        <div className='flex flex-col items-center gap-2 m-auto'>
            ...
            <div className='flex items-center gap-4 text-white'>
                ...
                <div ref={seekBg} onClick={seekSong} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer '>
                    <hr ref={seekBar} className='h-1 border-none w-0 bg-green-500' />
                </div>
